...
class HomeViewModel(
    ...
    private val _homeData: MutableLiveData<RepoSearchResponse> = MutableLiveData<RepoSearchResponse>()
    private val _loading: MutableLiveData<Boolean> = MutableLiveData<Boolean>()

    val homeData: LiveData<RepoSearchResponse> = _homeData
    ...
    fun fetchData(query: String, page: Int, perPage: Int) {
        ...
        viewModelScope.launch(Dispatchers.Main) {
            ...
            if (cacheJson.isNotEmpty()) {
                ...
                val cache = Gson().fromJson(cacheJson, RepoSearchResponse::class.java)
